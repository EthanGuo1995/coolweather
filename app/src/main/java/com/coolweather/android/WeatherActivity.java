...
public class WeatherActivity extends AppCompatActivity {
	...
	public SwipeRefreshLayout swipeRefresh;	//下拉刷新Layout
	private String mWeatherId;	//记录城市的天气id
	public DrawerLayout drawerLayout;	//获取DrawerLayout实例 -- 侧滑菜单布局
	private Button navButton;	//获取Button实例 -- 切换城市按钮
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		swipeRefresh.setColorSchemeResources(R.color.colorPrimary);	//设置下拉刷新进度条的颜色 -- 使用主题colorPrimary
	...
	public void requestWeather(final String weatherId) {
		String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId
				+ "&key=fb8e7c7c6aeb40d2b73c2d42ee5520e7";
